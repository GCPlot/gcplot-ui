    ...
    <section className="content-header">
      ...
      <section className="content">
        <Panel>
          ...
          <p>You can already upload and process your Hotspot GC logs. There is no limitations on the amount of transmitted data at the moment, so do not miss the moment and go to <code><NavLink to="/quick_process">Quick Process</NavLink></code> page. We are also working hard on the <u>Realtime Connection</u> feature, which will allow you to continuously connect your JVM GC logs with our platform.</p>
